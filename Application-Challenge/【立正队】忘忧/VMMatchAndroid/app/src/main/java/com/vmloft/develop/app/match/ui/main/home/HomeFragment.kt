...
import com.vmloft.develop.app.match.databinding.FragmentHomeBinding
import com.vmloft.develop.app.match.im.IMManager
import com.vmloft.develop.app.match.request.bean.Match
import com.vmloft.develop.library.common.request.RPaging
import com.vmloft.develop.app.match.request.bean.User
import com.vmloft.develop.app.match.router.AppRouter
import com.vmloft.develop.app.match.ui.widget.MatchDialog
...
class HomeFragment : BVMFragment<MatchViewModel>() {
    ...
    private fun setupEmotion() {
        floatMenu = VMFloatMenu(activity!!)
