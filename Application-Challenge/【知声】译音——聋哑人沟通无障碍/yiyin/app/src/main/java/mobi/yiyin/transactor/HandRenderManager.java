...
import mobi.yiyin.common.ArRuntimeException;
import mobi.yiyin.common.DisplayRotationManager;
import mobi.yiyin.common.TextDisplay;
import mobi.yiyin.common.TextureDisplay;
...
public class HandRenderManager implements GLSurfaceView.Renderer {
    ...
    private void updateMessageData(StringBuilder sb, ARHand hand) {
        ...
        sb.append("识别手势是：").append(getGestureTypeCH(hand));
...
//        addHandSkeletonStringBuffer(sb, hand);
    ...
    private String getGestureTypeCH(ARHand hand){
        String  description ="其他手势";
