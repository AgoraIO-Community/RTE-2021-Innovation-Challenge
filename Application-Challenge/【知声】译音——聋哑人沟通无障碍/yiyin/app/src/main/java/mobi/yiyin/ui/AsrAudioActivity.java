...
import mobi.yiyin.manager.SpeechRecognizerManager;
import mobi.yiyin.view.dialog.RecordDialog;

public class AsrAudioActivity extends BaseActivity implements View.OnClickListener {
    ...
    private final OnResultListener listener = new OnResultListener();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asr_audio);
...
//            }
    ...
    private final Runnable mGetVolumeLevelRunnable = new Runnable() {
        @Override
        public void run() {
            while (mIsRecording) {
                try {
