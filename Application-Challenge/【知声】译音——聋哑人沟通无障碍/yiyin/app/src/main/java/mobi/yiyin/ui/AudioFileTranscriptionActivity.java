...
import mobi.yiyin.record.AudioManager;
import mobi.yiyin.record.RecordingListener;
import mobi.yiyin.utils.FileUtils;
import mobi.yiyin.utils.UriFileInfoUtils;
import mobi.yiyin.view.dialog.RecordDialog;

public class AudioFileTranscriptionActivity extends BaseActivity implements View.OnClickListener {
    ...
    private final RecordingListener recordingStateListener = new RecordingListener() {
        @Override
    ...
    private final MLRemoteAftListener mAsrListener = new MLRemoteAftListener() {
