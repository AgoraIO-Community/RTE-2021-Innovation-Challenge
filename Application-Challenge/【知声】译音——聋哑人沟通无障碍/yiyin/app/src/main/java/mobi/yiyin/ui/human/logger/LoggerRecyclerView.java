package mobi.yiyin.ui.human.logger;
...
public class LoggerRecyclerView extends RecyclerView {
    ...
    private final LogRecyclerViewAdapter mAdapter = new LogRecyclerViewAdapter();
    private final MarginDecoration mDecoration = new MarginDecoration();
    private LayoutInflater mInflater;
    private final List<LogItem> mLogList = new ArrayList<>();
