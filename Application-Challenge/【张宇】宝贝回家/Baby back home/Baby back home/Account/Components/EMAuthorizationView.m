...
- (CAGradientLayer *)gl{
    if(_gl == nil){
        ...
        _gl.colors = @[(__bridge id)[UIColor colorWithRed:37/255.0 green:204/255.0 blue:189/255.0 alpha:1.0].CGColor, (__bridge id)[UIColor colorWithRed:55/255.0 green:250/255.0 blue:156/255.0 alpha:1.0].CGColor];
