...
//    [self.view insertSubview:imageView atIndex:0];
    ...
    self.sdkVersionLable.textColor = [UIColor colorWithRed:47/255.0 green:195/255.0 blue:154/255.0 alpha:1.0];
    self.sdkVersionLable.font = [UIFont systemFontOfSize:32 weight:(UIFontWeightBold)];
    self.sdkVersionLable.text = @"宝 贝 回 家";
    ...
    [self.nameField mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.backView).offset(30);
        make.right.equalTo(self.backView).offset(-30);
        make.top.equalTo(self.sdkVersionLable.mas_bottom).offset(90);
        make.height.equalTo(@55);
    }];
...
- (void)_setupLoginButton
{
    ...
    [registerButton setTitleColor:[UIColor colorWithRed:52/255.0 green:212/255.0 blue:170/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    [registerButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.authorizationView.mas_bottom).offset(20);
    }];
