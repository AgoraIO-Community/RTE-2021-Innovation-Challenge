...
namespace agora_gaming_rtc
{
    ...
    */
    public enum LOCAL_VIDEO_STREAM_ERROR 
    {
        ...
        /** 11: The shared window is minimized when you call {@link agora_gaming_rtc.IRtcEngine.StartScreenCaptureByWindowId StartScreenCaptureByWindowId} to share a window.
         */
    ...
    */
    public enum RTMP_STREAM_PUBLISH_ERROR
    {
        ...
        /** 3: Timeout for the RTMP or RTMPS streaming. Call the {@link agora_gaming_rtc.IRtcEngine.AddPublishStreamUrl AddPublishStreamUrl} method to publish the streaming again. */
    ...
    */
    ...
    public struct EncryptionConfig{
        ...
        */
        ...
        EncryptionConfig(ENCRYPTION_MODE _encryptionMode = ENCRYPTION_MODE.AES_128_XTS, string _encryptionKey = "") {
