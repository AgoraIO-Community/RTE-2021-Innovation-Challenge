...
#region DllImport
    ...
    // standard sdk api
        ...
        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int joinChannelWithUserAccount_engine(string token, string channelId, string userAccount, bool autoSubscribeAudio, bool autoSubscribeVideo);
        ...
        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int enableEncryption(bool enabled, string encryptionKey, int encryptionMode);
        ...
        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int enableEncryption2(IntPtr channel, bool enabled, string encryptionKey, int encryptionMode);
        ...
        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int joinChannelWithMediaOption(string token, string channelId, string info, uint uid, bool autoSubscribeAudio, bool autoSubscribeVideo);

        [DllImport(MyLibName, CharSet = CharSet.Ansi)]
        protected static extern int switchChannel2(string token, string channelId, bool autoSubscribeAudio, bool autoSubscribeVideo);
