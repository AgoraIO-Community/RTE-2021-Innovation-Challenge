...
namespace indoorNav
{
    public class NavLoadingScreen: MonoBehaviour
    {
        private static NavLoadingScreen instance = null;
        ...
        public static void LoadScene(string sceneName)
        {
            ...
            instance = Instantiate(Resources.Load<GameObject>(prefabName)).GetComponent<NavLoadingScreen>();
