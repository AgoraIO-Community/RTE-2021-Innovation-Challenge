...
namespace indoorNav
{
    ...
    public class NavWaypointManager : MonoBehaviour
    {
        ...
        /// <summary>
        public static readonly Dictionary<string, NavPathManager> Paths = new Dictionary<string, NavPathManager>();
        ...
        public static void AddPath(GameObject path)
        {
            ...
            NavPathManager pathMan = path.GetComponentInChildren<NavPathManager>();
            if(pathMan == null)
            {
