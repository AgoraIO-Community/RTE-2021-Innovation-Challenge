...
namespace indoorNav
{
    ...
    /// <summary>
    public class NavBezierPathManager : NavPathManager
    {
        /// <summary>
        ...
        void Awake()
        {
            NavWaypointManager.AddPath(gameObject);
        ...
        void OnDrawGizmos()
        {
            ...
            if (drawCurved && bPoints.Count >= 2)
                NavWaypointManager.DrawCurved(pathPoints);
            else
                NavWaypointManager.DrawStraight(pathPoints);
        }
