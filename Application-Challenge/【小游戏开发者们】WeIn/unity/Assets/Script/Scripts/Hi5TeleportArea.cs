...
{
	//-------------------------------------------------------------------------
	public class Hi5TeleportArea : TeleportMarkerBase
	{
		//Public properties
		...
		public void Start()
		{
			visibleTintColor = Hi5Teleport.instance.areaVisibleMaterial.GetColor(tintColorId);
			highlightedTintColor = Hi5Teleport.instance.areaHighlightedMaterial.GetColor(tintColorId);
			lockedTintColor = Hi5Teleport.instance.areaLockedMaterial.GetColor(tintColorId);
		}
		...
		public override void Highlight(bool highlight)
		{
			if (!locked)
			{
				...
				if (highlight)
				{
					areaMesh.material = Hi5Teleport.instance.areaHighlightedMaterial;
				}
				else
				{
					areaMesh.material = Hi5Teleport.instance.areaVisibleMaterial;
				}
			}
		}
		...
		public override void UpdateVisuals()
		{
			if (locked)
			{
				areaMesh.material = Hi5Teleport.instance.areaLockedMaterial;
			}
			else
			{
				areaMesh.material = Hi5Teleport.instance.areaVisibleMaterial;
		...
		public void UpdateVisualsInEditor()
		{
			...
			if (locked)
			{
				areaMesh.sharedMaterial = Hi5Teleport.instance.areaLockedMaterial;
			}
			else
			{
				areaMesh.sharedMaterial = Hi5Teleport.instance.areaVisibleMaterial;
			}
		}
