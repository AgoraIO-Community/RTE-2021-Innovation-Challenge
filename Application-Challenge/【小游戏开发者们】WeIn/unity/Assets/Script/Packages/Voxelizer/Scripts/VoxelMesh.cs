...
namespace VoxelSystem
{
    ...
    public class VoxelMesh {
		...
		public static Mesh Build(Voxel_t[] voxels, Vector3  unit, bool useUV = false) {
			...
			var up = Vector3.up * unit.y;
			var hup = up * 0.5f;
			var hbottom = -hup;

			var right = Vector3.right * unit.x;
			var hright = right * 0.5f;

			var left = -right;
			var hleft = left * 0.5f;

			var forward = Vector3.forward * unit.z;
