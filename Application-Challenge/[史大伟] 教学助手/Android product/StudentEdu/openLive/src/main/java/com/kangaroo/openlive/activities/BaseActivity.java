...
import com.kangaroo.openlive.utils.WindowUtil;
...
public abstract class BaseActivity extends AppCompatActivity implements EventHandler {
    ...
    public static AgoraApplication agoraApplication = null;

    protected com.kangaroo.openlive.AgoraApplication application() {
        return (com.kangaroo.openlive.AgoraApplication) agoraApplication;
    }
