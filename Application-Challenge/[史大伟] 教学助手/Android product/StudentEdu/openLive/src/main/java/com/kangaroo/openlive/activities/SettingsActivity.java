...
import com.kangaroo.openlive.ui.ResolutionAdapter;
import com.kangaroo.openlive.utils.PrefManager;

import static com.kangaroo.openlive.Constants.PREF_RESOLUTION_IDX;
...
public class SettingsActivity extends BaseActivity {
    ...
    private void saveShowStats() {
        ...
        mPref.edit().putBoolean(com.kangaroo.openlive.Constants.PREF_ENABLE_STATS,
    ...
    private void saveVideoMirrorMode(String key, int value) {
        if (TextUtils.isEmpty(key))
            return;
        switch (key) {
            case com.kangaroo.openlive.Constants.PREF_MIRROR_LOCAL:
                config().setMirrorLocalIndex(value);
                break;
            case com.kangaroo.openlive.Constants.PREF_MIRROR_REMOTE:
                config().setMirrorRemoteIndex(value);
                break;
            case com.kangaroo.openlive.Constants.PREF_MIRROR_ENCODE:
...
//                key = com.kangaroo.openlive.Constants.PREF_MIRROR_LOCAL;
//                textView = mMirrorLocalText;
//                break;
//            case R.id.setting_mirror_remote_view:
//                key = com.kangaroo.openlive.Constants.PREF_MIRROR_REMOTE;
//                textView = mMirrorRemoteText;
//                break;
//            case R.id.setting_mirror_encode_view:
//                key = com.kangaroo.openlive.Constants.PREF_MIRROR_ENCODE;
