...
import kotlinx.android.synthetic.main.activity_edit_dian_ping.*
...
/**
 * 自动生成：by WaTaNaBe on 2021-05-27 09:33
 * #点评课程详情#
 */
class EditDianPingActivity : BActivity(){

    companion object{

        fun startFrom(activity: Activity) {
            LibActivityLauncher.instance
                .launch(activity, EditDianPingActivity::class.java)
        }

    }

    override fun getLayoutId() = R.layout.activity_edit_dian_ping
    @JvmField
    @AutoPage
    ...
    override fun onViewCreated(savedInstanceState: Bundle?) {
        ...
        libCheckDialog.content("确定点评${kecheng}吗")
        ...
        libCheckDialog.onLibDialogListener =
            (object : LibCheckDialog.OnLibCheckDialogListener {
                override fun onSure() {
                    ...
                    showToastMsg(Tip.Success,"点评已完成")
                    finish()
                }
