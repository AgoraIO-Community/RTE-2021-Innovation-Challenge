 ...
 * #我的班级#
 */
class MyClassActivity : BActivity(){

    companion object{

        fun startFrom(activity: Activity) {
            LibActivityLauncher.instance
                .launch(activity, MyClassActivity::class.java)
        }

    }

    override fun getLayoutId() = R.layout.activity_my_class
    ...
    override fun onViewCreated(savedInstanceState: Bundle?) {
        ...
        libToolBarOptions.titleString = "我的班级"
    ...
    fun gaoEr3(view: View) {
        ClassListActivity.startFrom(visitActivity())
    }
