...
import com.kangaroo.studentedu.ui.presenter.XieHomeWorkPresenter
import kotlinx.android.synthetic.main.activity_xie_home_work.*
import com.kangaroo.studentedu.ui.adapter.XieHomeWorkAdapter
 ...
 * #写作业#
 */
class XieHomeWorkActivity : BMvpActivity<XieHomeWorkView ,XieHomeWorkPresenter>(),XieHomeWorkView{

    companion object{

        fun startFrom(activity: Activity) {
            LibActivityLauncher.instance
                .launch(activity, XieHomeWorkActivity::class.java)
        }

    }

    var adapter: XieHomeWorkAdapter? = null

    override fun getLayoutId() = R.layout.activity_xie_home_work
    ...
    override fun onViewCreated(savedInstanceState: Bundle?) {
        ...
        adapter!!.setOnItemClickListener { adapter, view, position ->
            ApXieHomeWorkDeatilActivity.newInstance().apply {
    ...
    override fun createPresenterInstance(): XieHomeWorkPresenter {
        return XieHomeWorkPresenter()
    }
