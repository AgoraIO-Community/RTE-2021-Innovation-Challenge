...
import kotlinx.android.synthetic.main.activity_xie_home_work_deatil.button
import kotlinx.android.synthetic.main.activity_xie_home_work_deatil.img
...
class XieHomeWorkDeatilActivity : BActivity(){
    ...
    override fun onViewCreated(savedInstanceState: Bundle?) {
        ...
        tkecheng.text = kecheng

        titlekecheng.text = kecheng+"第一次作业"
        content.text = "看图说话"
        teacherimg.setImageResource(R.mipmap.teacherjiangke)

        teacherimg.setOnClickListener {
        ...
        libCheckDialog.content("确定提交作业吗")
        ...
        libCheckDialog.onLibDialogListener =
            (object : LibCheckDialog.OnLibCheckDialogListener {
                override fun onSure() {
                    ...
                    showToastMsg(Tip.Success,"作业已提交")
                    finish()
                }
