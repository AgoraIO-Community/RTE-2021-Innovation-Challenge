...
$("#join-form").submit(async function (e) {
  ...
  try {
    options.appid = "e7b290f0fcee43b4977b38be04abd73b";
    options.token = "00694d3472478d14af98455c25fcaf010b0IABDMG4739X1RuPZSzY6hEDGU8P/mI4c5PIIOrk9PN0WRdJjSIgAAAAAEADEZWnpqyqyYAEAAQCrKrJg";
    options.channel = "123";
    options.uid = "Lily";
    await join();
    if(options.token) {
...
async function join() {
  ...
  $("#local-player-name").text(`我(${options.uid})`);
  ...
  if (mediaType === 'video') {
    const player = $(`
      <div id="player-wrapper-${uid}">
        <p class="player-name">毛毛老师(${uid})</p>
