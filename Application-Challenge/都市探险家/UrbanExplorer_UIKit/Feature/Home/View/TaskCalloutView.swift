...
class TaskCalloutView: UIView, MGLCalloutView {
  ...
  required init(representedObject: TaskAnnotation) {
  ...
  func presentCallout(from rect: CGRect, in view: UIView, constrainedTo constrainedRect: CGRect, animated: Bool) {
    ...
    if isCalloutTappable() {
      ...
      mainBody.addTarget(self, action: #selector(TaskCalloutView.calloutTapped), for: .touchUpInside)
    } else {
