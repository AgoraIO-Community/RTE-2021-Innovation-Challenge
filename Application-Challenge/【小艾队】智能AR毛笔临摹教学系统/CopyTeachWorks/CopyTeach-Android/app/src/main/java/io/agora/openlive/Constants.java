...
public class Constants {
    ...
    public static boolean ifOpenPreposition = true;
    public static String websocketUrl = "wss://ct.joeallen.top/websocket/xiaoai";
    public static boolean webSocketState = false;
