...
- (void)configControlAction
{
    ...
    [self.videoControl.xuanjiButton addTarget:self action:@selector(xuanjiClick:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)xuanjiClick:(UIButton *)button
{
    ...
    if (self.videoControl.listTableView.hidden == NO) {
        self.videoControl.listTableView.hidden = YES;

    }else{
    
    self.videoControl.listTableView.hidden = NO;
    }
...
- (void)fullScreenButtonClick
{
    ...
    self.videoControl.xuanjiButton.hidden = NO;
    
    self.videoControl.nextButton.hidden = NO;
    
    float ww = CGRectGetWidth(self.videoControl.playButton.bounds);
    
    self.videoControl.progressSlider.frame = CGRectMake(CGRectGetMaxX(self.videoControl.playButton.frame)+ ww, CGRectGetHeight(self.videoControl.bottomBar.bounds)/2 - CGRectGetHeight(self.videoControl.progressSlider.bounds)/2, CGRectGetMinX(self.videoControl.fullScreenButton.frame) - CGRectGetMaxX(self.videoControl.playButton.frame) - 45 - ww, CGRectGetHeight(self.videoControl.progressSlider.bounds));

    self.videoControl.timeLabel.frame = CGRectMake(CGRectGetMidX(self.videoControl.progressSlider.frame), CGRectGetHeight(self.videoControl.bottomBar.bounds) - CGRectGetHeight(self.videoControl.timeLabel.bounds) - 2.0, CGRectGetWidth(self.videoControl.progressSlider.bounds)/2, CGRectGetHeight(self.videoControl.timeLabel.bounds));
...
- (void)shrinkScreenButtonClick
{
    ...
    self.videoControl.xuanjiButton.hidden = YES;
    
    self.videoControl.nextButton.hidden = YES;

    
    self.videoControl.progressSlider.frame = CGRectMake(CGRectGetMaxX(self.videoControl.playButton.frame), CGRectGetHeight(self.videoControl.bottomBar.bounds)/2 - CGRectGetHeight(self.videoControl.progressSlider.bounds)/2, CGRectGetMinX(self.videoControl.fullScreenButton.frame) - CGRectGetMaxX(self.videoControl.playButton.frame) , CGRectGetHeight(self.videoControl.progressSlider.bounds));
