...
@interface DJNewsVC ()<NavgationViewDelegate,UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,NetworkErrorViewDeleagete>
{
    //最上边的二级分栏
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section == 0 && indexPath.row == 0){
        ...
        DJNewsCell *mCell =(DJNewsCell*)[tableView dequeueReusableCellWithIdentifier:mCellIdentifier];
        
        if (mCell==nil) {
            
            mCell = [[DJNewsCell alloc] initWithStyle:UITableViewCellStyleDefault
