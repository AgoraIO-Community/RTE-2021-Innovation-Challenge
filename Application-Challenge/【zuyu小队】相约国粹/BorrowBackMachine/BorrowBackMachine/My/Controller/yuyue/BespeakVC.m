...
@interface BespeakVC ()<NavgationViewDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.time  = [NSString stringWithFormat:@"预约时间 - %@",model.RetentionTime];
...
-(void)requestData
{
    ...
    [manager POST:PORT(@"BespeakRecord/mypage") parameters:parameter progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        if ([NSString stringWithFormat:@"%@",[responseObject objectForKey:@"IsDone"]].integerValue) {
            ...
            for (NSDictionary *itme in dataArray) {
                ...
                model.RetentionTime = [ZuyuJsonRead jsonRead:itme WithKey:@"RetentionTime"];
