...
#import "MJRefresh.h"
@interface BookselfContentVC ()<BookSelfNavViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
{
...
@implementation BookselfContentVC
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BookselfModel *model = _dataArray[indexPath.item];
...
{
    BookselfModel *model = _dataArray[indexPath.item];
    BookselfEntityVC *vc = [[BookselfEntityVC alloc] init];
    vc.model             = model;
