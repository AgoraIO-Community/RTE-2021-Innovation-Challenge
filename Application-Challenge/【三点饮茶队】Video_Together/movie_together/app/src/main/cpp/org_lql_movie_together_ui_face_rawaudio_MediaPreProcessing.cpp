...
#include <string.h>
#include "org_lql_movie_together_ui_face_rawaudio_MediaPreProcessing.h"
...
Java_org_lql_movie_1together_ui_face_rawaudio_MediaPreProcessing_setVideoCaptureByteBuffer
...
JNIEXPORT void JNICALL
Java_org_lql_movie_1together_ui_face_rawaudio_MediaPreProcessing_setAudioRecordByteBuffer
(JNIEnv *env, jclass, jobject bytebuffer)
{
...
JNIEXPORT void JNICALL
Java_org_lql_movie_1together_ui_face_rawaudio_MediaPreProcessing_setBeforeAudioMixByteBuffer
(JNIEnv *env, jclass, jobject bytebuffer)
{
...
JNIEXPORT void JNICALL
Java_org_lql_movie_1together_ui_face_rawaudio_MediaPreProcessing_setVideoDecodeByteBuffer
