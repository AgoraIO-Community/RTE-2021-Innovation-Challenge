package org.lql.movie_together.handler;

import org.lql.movie_together.model.AGEventHandler;
import org.lql.movie_together.model.BeforeCallEventHandler;
...
public class MyEngineEventHandler extends IRtcEngineEventHandler {
    ...
    public void onFirstLocalVideoFrame(int width, int height, int elapsed) {
        LogUtils.d("onFirstLocalVideoFrame " + width + " " + height + " " + elapsed);
    }
    ...
    public void onUserJoined(int uid, int elapsed) {
        LogUtils.d("onUserJoined " + (uid & 0xFFFFFFFFL) + elapsed);
    ...
    public void onUserMuteVideo(int uid, boolean muted) {
        LogUtils.d("onUserMuteVideo " + (uid & 0xFFFFFFFFL) + " " + muted);
    ...
    public void onRemoteVideoStats(RemoteVideoStats stats) {
        LogUtils.d("onRemoteVideoStats " + stats.uid + " " + stats.delay + " " + stats.receivedBitrate + " " + stats.rendererOutputFrameRate + " " + stats.width + " " + stats.height);
    ...
    public void onLastmileQuality(int quality) {
        LogUtils.d("onLastmileQuality " + quality);
        Iterator<AGEventHandler> it = mEventHandlerList.keySet().iterator();
        while (it.hasNext()) {
            AGEventHandler handler = it.next();
    ...
    public void onLastmileProbeResult(LastmileProbeResult result) {
        LogUtils.d("onLastmileProbeResult " + result);
        Iterator<AGEventHandler> it = mEventHandlerList.keySet().iterator();
        while (it.hasNext()) {
            AGEventHandler handler = it.next();
            if (handler instanceof BeforeCallEventHandler) {
    ...
    public void onError(int error) {
        LogUtils.d("onError " + error + " " + RtcEngine.getErrorDescription(error));
    ...
    public void onStreamMessage(int uid, int streamId, byte[] data) {
        LogUtils.d("onStreamMessage " + (uid & 0xFFFFFFFFL) + " " + streamId + " " + Arrays.toString(data));
    ...
    public void onStreamMessageError(int uid, int streamId, int error, int missed, int cached) {
        LogUtils.d("onStreamMessageError " + (uid & 0xFFFFFFFFL) + " " + streamId + " " + error + " " + missed + " " + cached);
    ...
    public void onJoinChannelSuccess(String channel, int uid, int elapsed) {
        LogUtils.d("onJoinChannelSuccess " + channel + " " + (uid & 0xFFFFFFFFL) + "(" + uid + ") " + elapsed);
    ...
    public void onAudioMixingStateChanged(int state, int errorCode) {
        LogUtils.d("onAudioMixingStateChanged() state = [" + state + "], errorCode = [" + errorCode + "]");
    }
