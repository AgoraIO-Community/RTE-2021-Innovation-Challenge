...
<head>
    ...
    <meta charset="utf-8" />
    <title>修改直播间 -<?php echo WEBNAME ?></title>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="appCertificate" placeholder="请输入声网appCertificate" class="col-xs-10 col-sm-5"
                                           value="<?php echo $info['appCertificate'];?>" maxlength="100">
                                    <br /><br />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="teacher_id" placeholder="请输入老师ID" class="col-xs-10 col-sm-5"
                                           value="<?php echo $info['teacher_id'];?>" maxlength="100">
                                    <br /><br />
                                    <font style="color:red;padding-left: 0;line-height: 33px;">
                                        *最大长度为100字符
                                    </font>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="teacher_name" placeholder="请输入老师昵称" class="col-xs-10 col-sm-5"
                                           value="<?php echo $info['teacher_name'];?>" maxlength="100">
                                    <br /><br />
                                    <font style="color:red;padding-left: 0;line-height: 33px;">
                                        *最大长度为100字符
                                    </font>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="room_uuid" placeholder="请输入房间号ID" class="col-xs-10 col-sm-5"
                                           value="<?php echo $info['room_uuid'];?>" maxlength="100">
                                    <br /><br />
                                    <font style="color:red;padding-left: 0;line-height: 33px;">
                                        *最大长度为100字符，房间号ID为唯一
                                    </font>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="room_name" placeholder="请输入房间名称" class="col-xs-10 col-sm-5"
                                           value="<?php echo $info['room_name'];?>" maxlength="100">
                                    <br /><br />
                                    <font style="color:red;padding-left: 0;line-height: 33px;">
                                        *最大长度为100字符
                                    </font>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            $("#<?php echo "room__add"?>Li").after('<li class="active">\n' +
                ...
                '                                <i class="menu-icon fa fa-caret-right"></i>编辑直播间\n' +
                '                            </a>\n' +
                '                            <b class="arrow"></b>\n' +
                '                        </li>');
