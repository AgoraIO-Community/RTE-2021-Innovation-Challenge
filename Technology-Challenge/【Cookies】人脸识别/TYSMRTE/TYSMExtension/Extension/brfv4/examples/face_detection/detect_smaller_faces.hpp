...
public: void initCurrentExample(brf::BRFManager& brfManager, brf::Rectangle& resolution) {
	...
	brf::trace("BRFv4 - basic - face detection - detect small faces" + brf::to_string("\n")+
	...
	int minFaceSize = _faceDetectionRoi.height * 0.10;	// 48 for 480,  72 for 720, 108 for 1080
	int maxFaceSize = minFaceSize + stepSize * 2;		// 72 for 480, 108 for 720, 162 for 1080
