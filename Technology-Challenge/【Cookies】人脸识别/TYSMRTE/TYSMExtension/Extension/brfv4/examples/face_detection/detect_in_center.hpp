...
public: void initCurrentExample(brf::BRFManager& brfManager, brf::Rectangle& resolution) {
	...
	brf::trace("BRFv4 - basic - face detection - detect face in center" + brf::to_string("\n")+
		"Limit detection area to the center of the image.");
	...
	_faceDetectionRoi.setTo(
		resolution.width * 0.20, resolution.height * 0.20,
		resolution.width * 0.60, resolution.height * 0.60
	);
