...
namespace agora {
    namespace extension {
        ...
        ExtensionVideoProvider::ExtensionVideoProvider() {
            ...
            waterMaskProcessor_ = new agora::RefCountedObject<WaterMaskProcessor>();
        }
        ...
        int ExtensionVideoProvider::setExtensionVendor(std::string vendor) {
            ...
            waterMaskProcessor_->setExtensionVendor(vendor.c_str());
            return 0;
        }
        ...
        agora_refptr<agora::rtc::IVideoFilter> ExtensionVideoProvider::createVideoFilter() {
            ...
            auto videoFilter = new agora::RefCountedObject<agora::extension::ExtensionVideoFilter>(waterMaskProcessor_);
            return videoFilter;
        }
        ...
        void ExtensionVideoProvider::setExtensionControl(rtc::IExtensionControl* control){
            waterMaskProcessor_->setExtensionControl(control);
        }
    }
}
